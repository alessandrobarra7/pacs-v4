...
## CORREÇÃO — DOWNLOAD DIRETO DO PDF FINANCEIRO
...
- [x] Atualizar a VM1 de `79b7931` para `7b9e341` sem migração, com novo PID do PM2, status online e HTTP local 200; sem ação na VM2.

## CORREÇÃO — FOLHAS DO GERADOR DIRETO DE PDF
...
## CORREÇÃO — REUTILIZAÇÃO DO DOWNLOAD PRINCIPAL NO FINANCEIRO
...
- [x] Substituir os favicons locais pela imagem ST7 fornecida, mantendo a aplicação independente de serviços externos
...
- [x] Corrigir o cadastro e a resolução de mapeamentos PACS para descrições DICOM vazias, com rastreabilidade de decisão
- [x] Adicionar migração não destrutiva para o sinalizador de descrição PACS vazia e origem de seleção automática
...
- [x] Reestruturar a tela principal para mostrar apenas o ciclo financeiro atual e seu rendimento operacional
- [x] Mover a consulta de ciclos anteriores para uma área histórica separada do painel atual
- [x] Exibir no histórico o fechamento do sistema com eventos, valor total e situação de pagamento
