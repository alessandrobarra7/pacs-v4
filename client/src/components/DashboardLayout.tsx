...
const ALL_MENU_ITEMS = [
  ...
  { icon: Users, label: "Administração", path: "/admin", roles: ['admin_master', 'unit_admin'] },
  { icon: DollarSign, label: "Módulo Financeiro", path: "/financeiro/dashboard", roles: ['admin_master'] },
