...
export default function Login() {
  ...
  return (
    <>
      <div
        className="relative flex min-h-[100dvh] w-full flex-col overflow-x-hidden bg-[#020b12] px-6 pb-8 pt-7 text-white md:hidden"
      ...
      >
        ...
        <header className="relative z-10 shrink-0">
          <div className="relative inline-block max-w-full">
            <span
              className="block text-[3.8rem] font-black leading-[0.9] text-white sm:text-[4.4rem]"
            ...
            <svg
              ...
              className="absolute left-0 top-[52%] h-6 w-full -translate-y-1/2"
              aria-hidden="true"
            >
              <motion.path
                d={ECG_PATH}
        ...
        <main className="relative z-10 mt-6">
          <section className="w-full rounded-xl border border-sky-500/25 bg-[#071426]/88 px-6 py-6 shadow-[0_0_42px_rgba(56,189,248,0.08)] backdrop-blur sm:px-8">
        ...
        <footer className="relative z-10 mt-6 shrink-0 space-y-3 text-xs leading-tight text-slate-400">
