...
import {
  ...
  FileText, Landmark, LockKeyhole, Printer, RefreshCw, Search,
} from "lucide-react";
...
export default function FinanceMeuFinanceiro() {
  ...
  const openConfiguredPrint = (report: typeof reports[number]) => {
    ...
    const params = new URLSearchParams({ document: target.document_key, documentLabel: target.document_label, unitId: String(target.unit_id), print: "1" });
